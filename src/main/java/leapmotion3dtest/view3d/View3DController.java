...
public class View3DController{
    ...
    public BooleanProperty displayInteractionBox;
    ...
    public  View3DController(SubScene subScene){
        ...
        displayInteractionBox = new SimpleBooleanProperty();
    ...
    private void initInteractionBox(){
        ...
        displayInteractionBox.bindBidirectional(interactionBox.visibleProperty());
    }

    private void initHand(){
        rightHand  = new HandView();
        rightHand.addToGroup(root);
        displayPalm.bindBidirectional(rightHand.displayPalm);
        displayFingers.bindBidirectional(rightHand.displayFingers);

        leftHand = new HandView();
        leftHand.addToGroup(root);
        displayPalm.bindBidirectional(leftHand.displayPalm);
        displayFingers.bindBidirectional(leftHand.displayFingers);
    }
